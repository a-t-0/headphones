...
class ImmutableDict(Mapping[Any, Any]):
    ...
    def __init__(
        self, arg: Union[Dict[Any, Any], Iterable[Tuple[Any, Any]]]
    ) -> None:
        """Initialize."""
    ...
    def _validate(
        ...
        if isinstance(arg, dict):
            ...
            [
                isinstance(k, Hashable) and isinstance(v, Hashable)
                for k, v in arg
            ]
        ):
            raise TypeError(
...
class Namespaces(ImmutableDict):
    ...
    def __init__(
        self, arg: Union[Dict[str, str], Iterable[Tuple[str, str]]]
    ) -> None:
        """Initialize."""
...
class SelectorList(Immutable):
    ...
    def __init__(
        self,
        selectors: Optional[
            Iterable[Union["Selector", "SelectorNull"]]
        ] = None,
        is_not: bool = False,
        is_html: bool = False,
    ) -> None:
