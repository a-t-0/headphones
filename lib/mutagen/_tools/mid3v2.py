        ...
        with _sig.block():
            ...
            for (frame, vlist) in edits.items():
                if frame == "POPM":
                    ...
                    mutagen.id3.Frames[frame], mutagen.id3.UrlFrame
                ):
