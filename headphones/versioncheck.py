...
import headphones
from headphones import logger, request, version
...
def getVersion():
    if version.HEADPHONES_VERSION.startswith("win32build"):
        ...
        if (
            headphones.CONFIG.DO_NOT_OVERRIDE_GIT_BRANCH
            and headphones.CONFIG.GIT_BRANCH
        ):
...
def checkGithub():
    ...
    url = "https://api.github.com/repos/{}/headphones/commits/{}".format(
    ...
    url = "https://api.github.com/repos/{}/headphones/compare/{}...{}".format(
        headphones.CONFIG.GIT_USER,
    ...
    if headphones.COMMITS_BEHIND > 0:
        logger.info(
            "New version is available. You are %s commits behind"
