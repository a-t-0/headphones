...
def getXldProfile(xldProfile):
    ...
    if not isinstance(preferences, dict):
        logger.error(
            "Error reading xld preferences plist, not a dict: %r", preferences
        )
        return (xldProfileNotFound, None, None)
            ...
            if OutputFormatName == "WAV":
                ...
                if (
                    ...
                    if XLDAacOutput2_VBRQuality > 122:
                        ...
                        XLDAacOutput2_VBRQuality > 113
                        and XLDAacOutput2_VBRQuality <= 122
                    ):
                        xldBitrate = 285
                    elif (
                        XLDAacOutput2_VBRQuality > 104
                        and XLDAacOutput2_VBRQuality <= 113
                    ):
                        xldBitrate = 255
                    elif (
                        XLDAacOutput2_VBRQuality > 95
                        and XLDAacOutput2_VBRQuality <= 104
                    ):
                        xldBitrate = 225
                    elif (
                        XLDAacOutput2_VBRQuality > 86
                        and XLDAacOutput2_VBRQuality <= 95
                    ):
                        xldBitrate = 195
                    elif (
                        XLDAacOutput2_VBRQuality > 77
                        and XLDAacOutput2_VBRQuality <= 86
                    ):
                        xldBitrate = 165
                    elif (
                        XLDAacOutput2_VBRQuality > 68
                        and XLDAacOutput2_VBRQuality <= 77
                    ):
                        xldBitrate = 150
                    elif (
                        XLDAacOutput2_VBRQuality > 58
                        and XLDAacOutput2_VBRQuality <= 68
                    ):
                        xldBitrate = 135
                    elif (
                        XLDAacOutput2_VBRQuality > 49
                        and XLDAacOutput2_VBRQuality <= 58
                    ):
                        xldBitrate = 115
                    elif (
                        XLDAacOutput2_VBRQuality > 40
                        and XLDAacOutput2_VBRQuality <= 49
                    ):
                        xldBitrate = 105
                    elif (
                        XLDAacOutput2_VBRQuality > 31
                        and XLDAacOutput2_VBRQuality <= 40
                    ):
                        xldBitrate = 95
                    elif (
                        XLDAacOutput2_VBRQuality > 22
                        and XLDAacOutput2_VBRQuality <= 31
                    ):
                        xldBitrate = 80
                    elif (
                        XLDAacOutput2_VBRQuality > 13
                        and XLDAacOutput2_VBRQuality <= 22
                    ):
                        xldBitrate = 75
                    elif (
                        XLDAacOutput2_VBRQuality > 4
                        and XLDAacOutput2_VBRQuality <= 13
                    ):
                        xldBitrate = 45
                    elif (
                        XLDAacOutput2_VBRQuality >= 0
                        and XLDAacOutput2_VBRQuality <= 4
                    ):
                        xldBitrate = 40
                ...
                if XLDVorbisOutput_Quality <= -2:
                    ...
                    XLDVorbisOutput_Quality > -2
                    and XLDVorbisOutput_Quality <= -1
                ):
                    xldBitrate = 48
                elif (
                    XLDVorbisOutput_Quality > -1
                    and XLDVorbisOutput_Quality <= 0
                ):
                    xldBitrate = 64
                elif (
                    XLDVorbisOutput_Quality > 0
                    and XLDVorbisOutput_Quality <= 1
                ):
                    xldBitrate = 80
                elif (
                    XLDVorbisOutput_Quality > 1
                    and XLDVorbisOutput_Quality <= 2
                ):
                    xldBitrate = 96
                elif (
                    XLDVorbisOutput_Quality > 2
                    and XLDVorbisOutput_Quality <= 3
                ):
                    xldBitrate = 112
                elif (
                    XLDVorbisOutput_Quality > 3
                    and XLDVorbisOutput_Quality <= 4
                ):
                    xldBitrate = 128
                elif (
                    XLDVorbisOutput_Quality > 4
                    and XLDVorbisOutput_Quality <= 5
                ):
                    xldBitrate = 160
                elif (
                    XLDVorbisOutput_Quality > 5
                    and XLDVorbisOutput_Quality <= 6
                ):
                    xldBitrate = 192
                elif (
                    XLDVorbisOutput_Quality > 6
                    and XLDVorbisOutput_Quality <= 7
                ):
                    xldBitrate = 224
                elif (
                    XLDVorbisOutput_Quality > 7
                    and XLDVorbisOutput_Quality <= 8
                ):
                    xldBitrate = 256
                elif (
                    XLDVorbisOutput_Quality > 8
                    and XLDVorbisOutput_Quality <= 9
                ):
                    xldBitrate = 320
