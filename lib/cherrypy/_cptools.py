...
class HandlerWrapperTool(Tool):
    ...
    def __init__(
        self, newhandler, point="before_handler", name=None, priority=50
    ):
...
class SessionTool(Tool):
    ...
    def _setup(self):
        ...
        if locking == "implicit":
            ...
            hooks.attach(
                "before_request_body", self._lock_session, priority=60
            )
        else:
            # Don't lock
            pass
...
class XMLRPCController(object):
    ...
    def default(self, *vpath, **params):
        ...
        _xmlrpc.respond(
            body, conf.get("encoding", "utf-8"), conf.get("allow_none", 0)
        )
        return cherrypy.serving.response.body
